  ...
  return (
    <section className="relative z-10 mx-auto grid min-h-[calc(100vh-4rem)] max-w-5xl items-center gap-10 md:grid-cols-[0.9fr_1fr]">
      <div>
        ...
        <h1 className="text-5xl font-bold leading-tight">Entra a tu banca digital.</h1>
        <p className="mt-5 max-w-md leading-7 text-slate-300">
          Accede con tu correo Gmail o usa Google para iniciar sesion de forma
          directa cuando conectemos la autenticacion.
        </p>
      </div>

      <div className="glass-panel rounded-2xl p-6">
      
        <h2 className="text-3xl font-bold">Inicio de sesion</h2>
        <p className="mt-2 text-slate-300">Ingresa para gestionar tus cuentas.</p>
